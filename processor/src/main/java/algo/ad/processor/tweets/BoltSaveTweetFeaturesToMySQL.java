...
public class BoltSaveTweetFeaturesToMySQL extends BaseBasicBolt {
	...
	public static Logger LOG = LoggerFactory.getLogger(BoltSaveTweetFeaturesToMySQL.class);

	public BoltSaveTweetFeaturesToMySQL(ApplicationConfigurationFile _configFile, boolean _isDebug) {
		super();
